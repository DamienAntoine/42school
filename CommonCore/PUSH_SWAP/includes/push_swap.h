...
void				sort_three(t_stack **astack_head, int smallest,
						int biggest);
...
t_bf				*find_optimal_nodes(t_stack *astack_head,
						t_stack *bstack_head);
t_bf				*find_smaller_cost(t_bf *optimal_pairs,
						t_stack *astack_head, t_stack *bstack_head);
t_bf				*find_pairs(t_stack *astack_head, t_stack *bstack_head);
void				free_pairs(t_bf *pairs);
void				append_pair(t_bf **head, t_bf **tail, t_stack *astack,
						t_stack *bstack);
...
void				put_on_top_both(t_stack **astack_head,
						t_stack **bstack_head, int avalue, int bvalue);
